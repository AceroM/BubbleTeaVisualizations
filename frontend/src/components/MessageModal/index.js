...
export default class MessageModal extends Component {
  ...
  componentDidMount() {
    const height = document.querySelector('.message-modal__inner').getBoundingClientRect().height;
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <MainColumn {...this.props} {...this.state} getMessageHeight={this.getMessageHeight.bind(this)} />
        <Footer
          {...this.props}
          {...this.state}
